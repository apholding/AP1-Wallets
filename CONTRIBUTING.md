Contributing to APH Core
============================

The APH Core project operates an open contributor model where anyone is
...
The following applies to code changes to the APH Core project, and is not to be
confused with overall APH Network Protocol consensus changes.

Whether a pull request is merged into APH Core rests with the project merge
...
Patches that change APH consensus rules are considerably more involved than
...
Where a patchset proposes to change the APH consensus, it must have been
...
The project leader is the release manager for each APH Core release.
