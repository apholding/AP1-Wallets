...
"""Verify that starting APH with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start APH with -? for help text")
        ...
        self.log.info("Start APH with -version for version information")
