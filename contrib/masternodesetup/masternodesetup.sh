...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='APH.conf'
CONFIGFOLDER='/root/.APH'
COIN_DAEMON='APHd'
COIN_CLI='APH-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/APH/APH/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
