...
#define MyAppName "APH Core"
#define MyAppPublisher "2021-2022 The APH Developers"
#define MyAppURL "https://github.com/apholding/APH"
#define MyAppExeName "APH-qt.exe"
#define MyAppExtraData "https://github.com/apholding/APH/releases/download/v2.0/bootstrap.zip"
...
[Files]
Source: ".\package\APH-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\APH\APH-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\APH\APH-Qt,strDataDir|{userappdata}\APH\}');
  Result := True;
end;
