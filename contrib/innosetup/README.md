...
* Fill in the following data:
    * Application Name: `APH Core`
    * Application Version: `2.0.0.0`
    * Application Publisher: `2021-2022 The APH Developers`
    * Application Website: `https://apholding.wordpress.com/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `APH`
* Add application files:
    * Select the file `APH-qt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `APH-2.0.0-win64-setup.exe`
