...
pkgdatadir = $(datadir)/APH
pkgincludedir = $(includedir)/APH
pkglibdir = $(libdir)/APH
pkglibexecdir = $(libexecdir)/APH
...
BITCOIN_CLI_NAME = APH-cli
BITCOIN_DAEMON_NAME = APHd
BITCOIN_GUI_NAME = APH-qt
BITCOIN_TX_NAME = APH-tx
...
OTOOL64 = 
PACKAGE = APH
PACKAGE_BUGREPORT = https://github.com/apholding/APH
PACKAGE_NAME = APH Core
PACKAGE_STRING = APH Core 2.0.0
PACKAGE_TARNAME = APH
PACKAGE_URL = https://apholding.wordpress.com/
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/APH-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/APH-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/APH-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/APH-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
