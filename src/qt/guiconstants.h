...
/* APH GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "APH"
#define QAPP_ORG_DOMAIN "APH.org"
#define QAPP_APP_NAME_DEFAULT "APH-Qt"
#define QAPP_APP_NAME_TESTNET "APH-Qt-testnet"
