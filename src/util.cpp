...
const char * const PIVX_CONF_FILENAME = "APH.conf";
const char * const PIVX_PID_FILENAME = "APH.pid";
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\APH
// Windows >= Vista: C:\Users\Username\AppData\Roaming\APH
// Mac: ~/Library/Application Support/APH
// Unix: ~/.APH
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "APH";
#else
    fs::path pathRet;
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty APH.conf if it does not exist
        ...
        if (configFile != NULL) {
	        ...
	        strHeader += "\nrpcport=27549\naddnode=seed1.apholding.wordpress.com:27550\naddnode=seed2.apholding.wordpress.com:27550\naddnode=seed3.apholding.wordpress.com:27550\naddnode=seed4.apholding.wordpress.com:27550\naddnode=seed5.apholding.wordpress.com:27550\naddnode=seed6.apholding.wordpress.com:27550\naddnode=seed7.apholding.wordpress.com:27550\naddnode=seed8.apholding.wordpress.com:27550\n";
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override APH.conf
