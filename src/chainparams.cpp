...
{
    const char* pszTimestamp = "APH 2.0 ";
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000265cfc30ca639a875ba1f4ae8f32eb2335a26eb2cd9996cc650770db559"))
...
public:
    CMainParams()
    {
    	...
    	vSeeds.push_back(CDNSSeedData("seed1",  "seed1.apholding.wordpress.com"));
        vSeeds.push_back(CDNSSeedData("seed2",  "seed2.apholding.wordpress.com"));
        vSeeds.push_back(CDNSSeedData("seed3",  "seed3.apholding.wordpress.com"));
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // APH starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        vSeeds.push_back(CDNSSeedData("tseeder", "tseeder.__apholding.wordpress.com__", true));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet APH addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet APH script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet APH BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet APH BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet APH BIP44 coin type is '1' (All coin's testnet default)
