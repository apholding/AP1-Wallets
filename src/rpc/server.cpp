...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* APH features */
        {"APH", "listmasternodes", &listmasternodes, true },
        {"APH", "getmasternodecount", &getmasternodecount, true },
        {"APH", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"APH", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"APH", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"APH", "masternodecurrent", &masternodecurrent, true },
        {"APH", "startmasternode", &startmasternode, true },
        {"APH", "createmasternodekey", &createmasternodekey, true },
        {"APH", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"APH", "listmasternodeconf", &listmasternodeconf, true },
        {"APH", "getmasternodestatus", &getmasternodestatus, true },
        {"APH", "getmasternodewinners", &getmasternodewinners, true },
        {"APH", "getmasternodescores", &getmasternodescores, true },
        {"APH", "mnsync", &mnsync, true },
        {"APH", "spork", &spork, true },
...
{
    return "> APH-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:27549/\n";
}
