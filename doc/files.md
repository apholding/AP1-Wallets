...
APH.conf           | contains configuration settings for APHd or APH-qt
APHd.pid           | stores the process id of APHd while running
...
debug.log           | contains debug information and general logging generated by APHd or APH-qt
